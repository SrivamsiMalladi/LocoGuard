...
public class PhoneContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(PhoneContactsActivity.this);
        ...
        ((Button) findViewById(R.id.selectContacts)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent selectGuardiansIntent = new Intent(PhoneContactsActivity.this, SelectGuardianActivity.class);
