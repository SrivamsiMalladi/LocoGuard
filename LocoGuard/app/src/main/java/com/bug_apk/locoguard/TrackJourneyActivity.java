...
public class TrackJourneyActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TrackJourneyActivity.this,WelcomeActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(dataSnapshot.exists()) {
                    if(dataSnapshot.getValue(String.class).equals("true")) {
                        ...
                        FirebaseDatabase.getInstance().getReference("journeys").child(journey.getWard()).child("finishLocation").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if(dataSnapshot.exists()) {
                                    Log.i("TrackJourneyActivity", "Adding stop location");
                                    com.bug_apk.locoguard.LatLng finishLocation = dataSnapshot.getValue(com.bug_apk.locoguard.LatLng.class);
        ...
        ((ImageButton) findViewById(R.id.Guardianslist)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ShowGuardiansFragment fragment = new ShowGuardiansFragment(userDetails.getWard());
        ...
        ((Button) findViewById(R.id.sos)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(TrackJourneyActivity.this, getString(R.string.trackJourney_noOngoingJourney), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ((ImageButton) findViewById(R.id.Profile)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TrackJourneyActivity.this,FriendsListActivity.class);
                intent.putExtra("userDetails", userDetails);
                intent.putExtra("Ongoing",true);
                startActivity(intent);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()) {
                            ...
                            if(guardiansList.size()==1) {
                                ...
                                Toast.makeText(TrackJourneyActivity.this, getString(R.string.trackJourney_stoppedTracking), Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(TrackJourneyActivity.this, WelcomeActivity.class);
                                intent.putExtra("userDetails", userDetails);
                                startActivity(intent);
                            }
...
//        mMap.setMyLocationEnabled(true);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()) {
                    if (userDetails.getPreferences().get("journeyCheckpointAdded").equals("true")) {
                        NotificationCompat.Builder builder = new NotificationCompat.Builder(TrackJourneyActivity.this, CHANNEL_ID)
                                .setContentTitle("Checkpoint added")
                                .setContentText(journey.getWardName() + " " + getString(R.string.trackJourneyActivity_checkPointAdded))
                                .setPriority(Notification.PRIORITY_HIGH)
                                .setSmallIcon(R.drawable.logo_locoguard);

                        NotificationManagerCompat notificationManager = NotificationManagerCompat.from(TrackJourneyActivity.this);
    ...
    private void setWardLocation() {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                com.bug_apk.locoguard.LatLng currentLocation = dataSnapshot.getValue(com.bug_apk.locoguard.LatLng.class);
